...
if __name__ == '__main__':
    clf, pose_label_dict_out = svm_test('sourcedata/201503141231/end_wifi.txt', 'data_save/20153141218end_pose.txt')
    # 没有尝试过交叉验证
    test_pose = numpy.loadtxt('data_save/20153141218end_pose.txt')
    test_wifi = numpy.loadtxt('data_save/20153141218end_wifi.txt')
